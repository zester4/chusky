...
const DEFAULTS: Record<string, string> = { DEFAULT_MODEL: "~deepseek/deepseek-v4-flash-latest", VISION_MODEL: "openai/gpt-5.6-luna", TRANSCRIPTION_MODEL: "openai/gpt-transcribe", IMAGE_MODEL: "openai/gpt-image-1", VIDEO_MODEL: "bytedance/seedance-2.0-mini", PORT: "8080" };
