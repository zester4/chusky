...
export const CHANNEL_CAPABILITIES: Record<ChannelProvider, ChannelCapabilities> = {
  ...
  sendblue: { supportsThreads: false, supportsStreaming: false, supportsFiles: true, supportsMarkdown: false, supportsButtons: false, supportsTyping: false, maxTextLength: 4096 },
