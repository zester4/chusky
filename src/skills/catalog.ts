...
const ROUTED_SKILLS: Array<{ name: string; triggers: string[] }> = [
  ...
  { name: "meeting-pro", triggers: ["meeting", "zoom", "teams", "google meet", "standup", "discovery call", "sales call"] },
  ...
  { name: "computer-pro", triggers: ["daytona", "sandbox", "browser automation", "computer use", "desktop"] },
  ...
  { name: "decision-pro", triggers: ["tradeoff", "decide between", "recommendation", "options matrix"] },
  { name: "verification", triggers: ["verify", "evidence check", "done when", "acceptance criteria"] },
  { name: "handoff", triggers: ["handoff", "delegate to worker", "resume packet"] },
  { name: "fullstack-dev", triggers: ["fullstack", "full-stack", "implement feature", "build the app", "react", "next.js", "api route"] },
  { name: "senior-fullstack", triggers: ["architecture", "system design", "senior engineer"] },
  { name: "codebase-design", triggers: ["codebase design", "module boundaries", "folder structure"] },
  ...
  { name: "better-auth-best-practices", triggers: ["better auth", "better-auth"] },
  { name: "content-strategy", triggers: ["content strategy", "content plan", "editorial"] },
  ...
  { name: "imagine", triggers: ["generate image", "image prompt", "visual asset"] },
  { name: "video-editing", triggers: ["video edit", "video editing", "edit the video"] },
  ...
  { name: "triage", triggers: ["triage this", "prioritize queue"] },
];
