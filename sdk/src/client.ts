...
export class CallsResource {
  ...
  request(params: { phoneNumber: string; purpose: string; profile?: Partial<VoiceCallProfile> }, options?: RequestOptions): Promise<CallRecord> {
...
export class OperatorResource {
  ...
  readiness(options?: RequestOptions): Promise<OperatorReadiness> { return this.client.request("/operator/readiness", {}, options); }
