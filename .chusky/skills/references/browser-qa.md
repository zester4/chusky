...
**not** the user's Chusky chat tab. Use whatever browser capability you have
**yourself**, so quality beats curl-only.

1. **Chusky browser / computer-use / MCP browser tools**, if listed — open
...
cam) per `.chusky/skills/controls/SKILL.md` — you don't have to play end-to-end,
