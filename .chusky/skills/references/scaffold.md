...
export const Route = createRootRoute({
  head: () => ({
    ...
    links: [
      ...
      { rel: "manifest", href: "/__chusky/manifest.webmanifest" },
      { rel: "apple-touch-icon", href: "/__chusky/icon-180.png" },
    ],
  }),
  component: () => (
    <html lang="en" suppressHydrationWarning>
      ...
      <body>
        {/* Keep this bridge — lets the Chusky preview chrome drive the app; noops when not embedded. */}
        <PreviewHostBridge />
        <AuthProvider>
          <Outlet />
        </AuthProvider>
